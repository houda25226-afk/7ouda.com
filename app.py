...
def _inject_wataniya_identity_css():
    """حقن هوية الوطنية: خلفية كريمية + زخرفة واضحة بدون بلور."""
    t = THEME
    is_light = THEME_NAME == "light"

    _LEFT_DECO_B64 = ""
    _RIGHT_DECO_B64 = ""
...
/* خلفية الصفحة — زخرفة واضحة حادة بدون بلور */
.stApp {{
