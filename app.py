...
/* ===== هيدر إيجادة المنفصل (فوق التبويبات بالكامل) ===== */
.ejada-shell {{
  width: 100%;
...
.ejada-topbar {{
  background: linear-gradient(100deg, #052018 0%, #0A3326 28%, #0F4434 52%, #0A3326 78%, #052018 100%);
  border-bottom: 2px solid rgba(201, 168, 76, 0.65);
  padding: 0.85rem 1.25rem;
  margin: 0;
  border-radius: 14px;
  text-align: center;
  box-shadow: 0 6px 22px rgba(13, 61, 46, 0.28);
  position: relative;
  overflow: visible;
}}
.ejada-topbar::before {{
  ...
  background:
    repeating-linear-gradient(
      ...
      transparent,
      transparent 14px,
      rgba(201, 168, 76, 0.05) 14px,
      rgba(201, 168, 76, 0.05) 28px
    ),
    radial-gradient(ellipse 55% 80% at 8% 50%, rgba(201,168,76,0.09), transparent 55%),
    radial-gradient(ellipse 50% 70% at 92% 50%, rgba(201,168,76,0.08), transparent 50%);
  pointer-events: none;
}}
.ejada-topbar-inner {{
  position: relative;
...
/* بطاقة المحتوى منفصلة عن الهيدر */
.ejada-content-card {{
  background: {t["surface"]};
  border: 1px solid {t["border"]};
  border-radius: 16px;
  box-shadow: 0 12px 40px rgba(13, 61, 46, 0.10);
...
""",
    ...
    st.markdown(
        """
<div class="ejada-shell">
  <div class="ejada-topbar">
    <div class="ejada-topbar-inner">
      <div class="ejada-logo-mark">
        <img src="data:image/png;base64," alt="Ejada Logo" />
      </div>
      ...
      <div class="ejada-logo-mark">
        <img src="data:image/png;base64," alt="Ejada Logo" />
      </div>
    </div>
  </div>
...
# بطاقة المحتوى منفصلة عن الهيدر — كل التبويبات جواها
st.markdown(
    """
<div class="ejada-content-card">
  <div style="clear:both;text-align:left;direction:ltr;margin:0 0 0.5rem 0;">
...
<div class="ejada-side-brand">
  <div class="ejada-side-logo">
    <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="40" height="40">
      ...
      <rect x="1" y="1" width="46" height="46" rx="14" fill="url(#sg)"/>
      <path d="M24 9c5 6 11 10 14 11-3 2-8 6-9 14-1-6-5-11-10-12 5-1 7-6 5-13z" fill="url(#gold)"/>
      <path d="M18 30c3-1 6 0 9 2 1 5-2 10-5 11-5-3-8-8-4-13z" fill="url(#gold)" opacity="0.85"/>
      <ellipse cx="24" cy="37" rx="9" ry="2.4" fill="url(#gold)" opacity="0.55"/>
    </svg>
  </div>
...
""",
    ...
    for page_label in PAGES:
        is_active = selected_page == page_label
        if st.button(
            page_label,
...
PAGES[st.session_state.get("selected_page", DEFAULT_PAGE)]()

st.markdown("</div><!--ejada-content-card-end-->", unsafe_allow_html=True)
